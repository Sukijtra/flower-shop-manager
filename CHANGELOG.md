...
Planner / Architect (มีน): Designed the project structure, system architecture, database concept, and Sprint 1 development plan.
Coder / Dev (องุ่น): Implemented the Python project structure, OOP classes, CLI menu, API integration, and database functions.
Debugger / QA (วิว): Tested system functions, checked input handling, and verified database and statistics operations.
Debugger / QA (แม็ก): Assisted with testing, error checking, and validation of system functionality.